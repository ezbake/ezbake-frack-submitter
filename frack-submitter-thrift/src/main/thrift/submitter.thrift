...
/*
 * This exception signifies that no pipeline was running with the provided name when
 * attempting a shutdown event.
 */
...
service Submitter extends ezbakeBaseService.EzBakeBaseService {
